...
export function MemorandumForm() {
  ...
  const handleExport = async () => {
    ...
    // The signature image is a data URI, we need to extract the base64 part.
      ...
      sections: [
        {
          children: [
            ...
            new Paragraph({ text: "" }),
            new Paragraph({ text: formData.body }),
             new Paragraph({ text: "" }),
            new Paragraph({
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
            ...
            <Input id="action-required" value={formData.actionRequired} onChange={handleInputChange} />
        </div>
            ...
            <div className="flex items-center gap-6">
                <SignaturePad sigPadRef={sigPadRef} />
                 <div className="grid w-full max-w-xs items-center gap-1.5">
                    ...
                    <Input id="signatureDate" type="date" value={formData.signatureDate} onChange={handleInputChange} />
                </div>
            </div>
